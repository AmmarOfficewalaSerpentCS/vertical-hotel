...
var RoomSummary = form_common.FormWidget.extend(form_common.ReinitializeWidgetMixin, {
	  ...
	  initialize_content: function() {
		...
		load_form: function(data) {
			...
			// To open wizard for free rooms/campsites & do a confirmed reservation from room summary
			...
			// To open wizard for reserved rooms/campsites
			...
			this.$el.find(".table_reserved").bind("click", function(event){
				self.action_manager.do_action({
					...
					res_id:$(this).data("reid"),
					// domain: [['id', '=', $(this).data("reid")]],
					views: [[false, 'form']],
					target: 'new'
				  });
			  });
