...
//    ajaxindicatorstart('Loading');
	...
	$(document).on('change', '.select_count', function(e){
        ...
        // sum = $('.adult_counter').val() + $('.child_counter').val();
        // var pets = $('.pet_counter').val();
        // var room_guest = $("#room_guest").val()
...
$(document).on('click', '#paypal_pay_now', function(e){
    ...
    alert(typeof $("input[name='check_IN']").val())
...
// $(".adult_counter").on("change", "li", function(e){
// 	e.preventDefault();
//     alert($(this).val());
//     var $this = $(this);
